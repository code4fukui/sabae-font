// export-hiragana-a.js
// 使い方: node export-hiragana-a.js ./YourFont.ttf ./a.svg
import * as opentype from "https://code4fukui.github.io/opentype-es/opentype.js";
//import opentype from 'opentype.js';

//const [,, fontPath, outPath = 'a.svg'] = process.argv;
const fontPath = "./NotoSansJP-Light.ttf";
const outPath = "./noto-a.svg";
if (!fontPath) {
  console.error('Usage: node export-hiragana-a.js <font.ttf> [out.svg]');
  process.exit(1);
}
